const perguntas = [
  ...
  // transferi o template para o código JS
  ...
  for(const item of perguntas) {
    ...
    for (let resposta of item.respostas){
      ...
      //define a seleção de pergunta por respostas
      dt.querySelector('input').setAttribute('name', 'pertgunta-' + perguntas.indexOf(item))
      ...
      dt.querySelector('input').onchange = (event) => {
        ...
        // deleta a contagem de corretas de item
    ...
    // remove a resposta A da seleção
